...
# ######## BAI 1 ###################
# action_labels_1 =  ['0','0','0','0','sit','sit','stand','0','0']
# ######## BAI 2 ###################
# action_labels_2 =  ['0','0','0','0','0','squat','stand','0','0']
# ######## BAI 3 ###################
# action_labels_3 =  ['jump','0','0','0','0','0','0','0','0']
# ######## BAI 4 ###################
# action_labels_4=  ['0','0','0','run','0','0','0','0','0']
...
def draw_resulf(image,label):
    
    font = cv2.FONT_HERSHEY_DUPLEX
    cv2.rectangle(image, (100, 60), (0, 0), (255, 255, 255), cv2.FILLED)
    cv2.putText(image, 'label', (0,30), font, 1.0, (255, 0, 255), 1, cv2.LINE_AA)
    if label!='none':
        cv2.putText(image, label, (0,60), font, 1.0, (255, 0, 255), 1, cv2.LINE_AA)
